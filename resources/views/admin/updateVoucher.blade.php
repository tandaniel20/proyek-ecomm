                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col" style="text-align: left; vertical-align: middle;">
                            <input class="w-50" type="text" name="judul" id="" placeholder="Judul Voucher" value="{{ $voucher["judul"] }}">
                        </div>
                        @error('judul')
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="text-align: left; vertical-align: middle;">
                            <input type="text" class="w-50" name="kode" id="kodeVoucher" placeholder="Kode Voucher" onclick="getValue();" value="{{ $voucher["kode"] }}">
                        </div>
                        @error('kode')
                            <span style='color: red'>{{ $message }}</span>
                        @enderror
                    ...
                    <div class="row" style="text-align: center;">
                        <div class="col"></div>
                        <div class="col-2">
                            <button type="submit" class="btn btn-success btn-block">Update Voucher</button>
                        </div>
                        <div class="col"></div>
                    </div>
                </div>
